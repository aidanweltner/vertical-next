    ...
    <>
      <section className="w-screen block relative h-screen xl:h-85 -mb-1 bg-cover">
        <div className="absolute inset-0 section-inner z-10 h-full flex flex-col content-between">
          ...
          <Link href={href}> 
            <a className="lg:bg-primary hover:bg-red-600 focus:bg-red-600 shadow-md hover:shadow-lg p-2 my-4 lg:my-0 lg:p-6 lg:text-xl font-semibold text-sm uppercase tracking-wide text-white flex items-center md:justify-start justify-center lg:justify-center border-none">
              {title}
